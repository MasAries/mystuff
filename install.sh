...
cd /etc/apache2/sites-available/ && wget https://raw.githubusercontent.com/bgserrano/mystuff/master/000-default.conf
##############################################################################
# My IP : config_template.php , config.php
rm /var/www/myiptv/config/config_template.php
cd /var/www/myiptv/config/ && wget https://raw.githubusercontent.com/bgserrano/mystuff/master/config_template.php
##############################################################################
# My IP : config_template.php , config.php
rm /var/www/myiptv/config/config.php
cd /var/www/myiptv/config/ && wget https://raw.githubusercontent.com/bgserrano/mystuff/master/config.php
##############################################################################
rm /etc/apache2/mods-enabled/fastcgi.conf
cd /etc/apache2/mods-enabled/ && wget https://raw.githubusercontent.com/bgserrano/mystuff/master/fastcgi.conf
##############################################################################
wget -O /etc/apache2/apache2.conf https://raw.githubusercontent.com/bgserrano/mystuff/master/apache2.conf
##############################################################################
